...
<form method="post">
	<table class="table">
		<thead>
			...
			<th><a href="sortbycategory.php">Sort by category </a></th>
			<th><a href="sortbyprice.php">Sort by price </a></th>
			<th><a href="logout.php"> Logout</a></th>			
		</thead>
	</table>
	<input type="text" name="enterid" class="form-control col-6" placeholder="Enter id to rate">
	<input type="number" name="rate" class="form-control col-6" placeholder="Enter Rating">
	<input style="margin-left: 25px;" class='btn btn-dark' type='submit' name='ratings' value='Submit ratings'>
		<div class="abc">
		<?php 	
		foreach ($rows as $res) {
			$a= '';
	  ...
	  <div class='card-body'>
	    ...
	    <h6 class='card-subtitle mb-2 text-muted'>Ratings: $res->ratings</h6>
	  </div>
	</div>";
	}
?>
